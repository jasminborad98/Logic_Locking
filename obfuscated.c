...
void ByteSub_ShiftRow(int nb,int n,int key1,int key2,int key3,int key4,bool key5,bool key6,bool key7)
{
  int temp;
  if(nb==4)
  {
      temp = key5 ? Sbox[statemt[8] >> 4][statemt[8] & 0xf] : Sbox[statemt[1] >> 4][statemt[1] & 0xf];
      statemt[1] = Sbox[statemt[key1] >> 4][statemt[key1] & 0xf];
      statemt[key1] = Sbox[statemt[9] >> 4][statemt[9] & 0xf];
      statemt[9] = Sbox[statemt[13] >> 4][statemt[13] & 0xf];
      statemt[13] = temp;

      temp = key6 ? Sbox[statemt[6] >> 4][statemt[6] & 0xf] : Sbox[statemt[2] >> 4][statemt[2] & 0xf];
      ...
      temp = key7 ? Sbox[statemt[15] >> 4][statemt[15] & 0xf] : Sbox[statemt[3] >> 4][statemt[3] & 0xf];
